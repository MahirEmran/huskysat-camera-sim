...
then ```pip install bsk``` then ```pip install pytest```

Then can run ```python simulate_cubesat.py```

Open Vizard and put in the ```output.bin``` file :)
